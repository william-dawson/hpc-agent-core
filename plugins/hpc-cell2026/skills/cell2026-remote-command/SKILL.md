---
name: cell2026-remote-command
description: Use when the user wants to run one or more shell commands on cell2026 (Shinobu Lab)'s login node, or when another workflow needs run_command_on_cluster for a live check not covered by a safer typed tool. Requires an exact command preview and explicit user permission before execution.
user-invocable: true
---

# Running login-node commands on cell2026 (Shinobu Lab)

Every call in this skill uses `facility="cell2026"`.
...
> I propose three short, read-only checks on cell2026 (Shinobu Lab):
>
...
> commands on cell2026 (Shinobu Lab)?
